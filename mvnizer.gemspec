...
Gem::Specification.new do |s|
  ...
  s.summary = "Boostraps a Maven project without the pain of archetypes."
  s.description = "Mvnizer boostraps a Maven project without the pain of archetypes."
  
  s.authors = ["Sébastien Le Callonnec"]
