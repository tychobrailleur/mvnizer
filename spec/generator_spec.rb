...
#RSpec.configure { |c| c.filter_run_excluding :deprecated => true }
...
#     it "generates a pom", deprecated: true do
...
#     it "adds the packaging when the type is not jar", deprecated: true do
...
#     it "adds the dependencies", deprecated: true do
